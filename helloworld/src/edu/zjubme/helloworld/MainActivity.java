...
public class MainActivity extends Activity implements ActionBar.TabListener {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			switch (position) {
			case 0:
				return new MainPersonInfoFragment();
			case 1:
	...
	public void cl_to_choose_career (View view){
		...
		final String[] items = new String[]{"教师","学生","其他"};
		builder.setSingleChoiceItems(items, 1, new OnClickListener() {
			...
			TextView textview01 =(TextView)findViewById(R.id.main_tv_career01) ;
		    textview01.setText(items[which]);
				}
		});
		builder.show();
	}	
	public void cl_to_dial(View v){
		EditText et_number = (EditText)MainActivity.this.findViewById(R.id.main_et_phone);
